...
trained_model = train_fno_interpolant(
    ...
    epochs=500,
    device='cuda',
    save_path='Stochastic_Interpolant_knownbase_GA.pth',
)
...
trained_model = train_fno_interpolant(
    ...
    epochs=500,
    device='cuda',
    save_path='Stochastic_Interpolant_knownbase_MP.pth',
)
...
trained_model = train_fno_interpolant(
    ...
    epochs=500,
    device='cuda',
    save_path='Stochastic_Interpolant_knownbase_NoReg.pth',
)
...
trained_model = train_fno_interpolant(
    ...
    epochs=200,
    device='cuda',
    save_path='Stochastic_Interpolant_knownbase.pth',
)
