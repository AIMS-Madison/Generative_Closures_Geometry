...
trained_model = train_fno_interpolant(
    ...
    epochs=500,
    device=device,
    save_path=resolve_output_path('Trained_Models/SI/Latent_SI/L-SI_GA_Empirical.pth'),
)
...
trained_model = train_fno_interpolant(
    ...
    epochs=500,
    device=device,
    save_path=resolve_output_path('Trained_Models/SI/Latent_SI/L-SI_MP_Empirical.pth'),
)
...
trained_model = train_fno_interpolant(
    ...
    epochs=500,
    device=device,
    save_path=resolve_output_path('Trained_Models/SI/Latent_SI/L-SI_ReconOnly_Empirical.pth'),
)
...
trained_model = train_fno_interpolant(
    ...
    epochs=200,
    device=device,
    save_path=resolve_output_path('Trained_Models/SI/Physics_SI/P-SI_Empirical.pth'),
)
